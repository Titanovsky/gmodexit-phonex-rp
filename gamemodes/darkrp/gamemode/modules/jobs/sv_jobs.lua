...
function meta:changeTeam(t, force, suppressNotification, ignoreMaxMembers)
    ...
    if AmbStats.Players.getStats( self, '!' ) < RPExtraTeams[t].lvl and not force then
        notify(self, 1, 4, DarkRP.getPhrase("unable", team.GetName(t), "Нужен уровень: "..RPExtraTeams[t].lvl))
        return false
    end
