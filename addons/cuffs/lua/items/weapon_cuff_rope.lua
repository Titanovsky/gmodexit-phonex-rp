...
ITEM = {}
ITEM.Name 		 =  "Handcuffs (Rope Restraint)"
ITEM.Angle		 =  Angle(0,0,0)
ITEM.Desc		 =  "A variant of restraining handcuffs."
...
ITEM.Weapon		 =  "weapon_cuff_rope"
ITEM.ReqCraft = {"item_part_a", "item_part_b", "item_part_e", "item_part_c", "item_plantfibre", "item_plantfibre"}
