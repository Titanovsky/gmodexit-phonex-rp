...
local function CalcMoney( nType )
	...
	local money = math.random( AmbFactory2Chunks[ nType ].min_pay , AmbFactory2Chunks[ nType ].max_pay )
...
function ENT:PutWorkpiece( nType, ePly )
	...
	AmbLib.chatSend( ePly, AMB_COLOR_GREEN, '[•] ', AMB_COLOR_WHITE, 'Вы получили ', AMB_COLOR_GREEN, money..'$', AMB_COLOR_WHITE, ' за ', AMB_COLOR_GRAY, AmbFactory2Chunks[ nType ].chunk )
